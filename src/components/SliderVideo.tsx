...
const SliderVideo = ({ item }: { item: MovieBaseProps }) => {
                        ...
                        <div className="flex-1 flex flex-col gap-4">
                            ...
                            <div className="flex items-center">
                                <div className="relative flex items-center gap-1">
                                    <span className="border-b">{item.vote_average}</span>
                            ...
                            <div className="mt-5">
                                <Button
                                    onClick={() =>
                                        router.push(
                                            `${item.media_type == 'movie' ? '/movies' : '/tv-shows'}/${item.id}`,
                                        )
                                    }
                                    title="Play Now"
                                    icon={<FaPlay />}
                        ...
                        <div className="relative flex-1 flex items-center overflow-hidden group">
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                <div className="flex flex-col items-center gap-3">
                                    <button className="border p-7 rounded-full" title="play">
